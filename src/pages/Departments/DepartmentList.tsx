...
export default function DepartmentList() {
  ...
  const openEdit = (d: any) => { setMode("edit"); setEditing(d); setShowForm(true); };
  ...
  return (
    <main className="page-wrap table-page">
      ...
      {loading ? (
        ...
        <div className="card table-card"><div className="error">{error}</div></div>
      ) : (
              ...
              {filtered.length === 0 ? (
                ...
                <tr key={d.id}>
                  ...
                  {isAdmin ? (
                    ...
                    <td><span className="muted">Restricted</span></td>
                  )}
                </tr>
              ))}
            </tbody>
